...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            logging.info("fiscore precesion score,recall score calculated")



            if regression_train_metric.f1_score <= self.model_trainer_config.expected_accuracy:
                logging.info("checking model accuracy and if less than expected accuracy it will raise eero ")
            ...
            logging.info("checking overfitting and underfitting of model ")
